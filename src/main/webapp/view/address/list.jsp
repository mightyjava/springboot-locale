...
<div class="panel panel-default">
	<div class="panel-heading">
		<strong>
			<span class="glyphicon glyphicon-list"></span> <spring:message code="label.address.list"/>
		</strong>
		<div class="btn-group pull-right">
			<a href="javascript:void(0);" class="btn btn-default btn-sm" onclick="addForm('address')" title='<spring:message code="label.addnew.address"/>'>
				<span class="glyphicon glyphicon-plus-sign"></span>
			</a>
			<a href="javascript:void(0);" class="btn btn-default btn-sm" onclick="refresh('address')" title='<spring:message code="label.refresh.address"/>'>
		...
		<table class="table table-bordered table-condensed table-hover table-striped">
			<thead>
				<tr>
					...
					<th><spring:message code="label.addressline"/></th>
			...
			<tbody>
				<c:choose>
					...
					<c:otherwise>
						<tr align="center">
							<td colspan="8"><spring:message code="label.noaddresses.available"/></td>
						</tr>
					</c:otherwise>
				</c:choose>
			</tbody>
		...
		<div class="panel-footer">
			...
			<ul class="pagination pull-right" style="margin:-7px;">
				<c:choose>
					...
					<c:otherwise>
						<li><a href="javascript:void(0);" onclick="list('address', '1')"><spring:message code="label.first"/></a></li>
						<li><a href="javascript:void(0);" onclick="list('address', '${current - 1}')"><spring:message code="label.previous"/></a></li>
					</c:otherwise>
				</c:choose>
				...
				<c:choose>
					...
					<c:otherwise>
						<li><a href="javascript:void(0);" onclick="list('address', '${current + 1}')"><spring:message code="label.next"/></a></li>
						<li><a href="javascript:void(0);" onclick="list('address', '${totalPages}')"><spring:message code="label.last"/></a></li>
					</c:otherwise>
				</c:choose>
			</ul>
		</div>
